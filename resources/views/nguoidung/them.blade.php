            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('nguoidung') }}">Quản lý tài khoản người dùng</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"  placeholder="Tên người dùng" value="{{ old('name') }}" required />
                                    @error('name')
