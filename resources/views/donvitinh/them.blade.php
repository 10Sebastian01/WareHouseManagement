        ...
        <section class="content">
            <div class="col-md">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ route('donvitinh.them') }}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên đơn vị</label>
                                <input type="text" class="form-control @error('dvt') is-invalid @enderror" id="dvt" name="dvt"  placeholder="Tên đơn vị" value="{{ old('dvt') }}" required />
                                @error('dvt')
